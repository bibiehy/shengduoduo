...
// 异常上报
export const fetchExceptionReport = (params) => ({ url: '/driver/report', method: 'post', loading: true, delay: 500, data: params });

// 异常列表-暂时没有
export const fetchExceptionList = (params) => ({ url: '/dispatcher/getDriverList', method: 'get', data: { size: 20, ...params } });

// 查看异常 - 单个，用于调度员和提货点负责人
export const fetchExceptionView = (params) => ({ url: `/driver/getException/${params['id']}`, method: 'get', loading: true, delay: 500 });

// 查看异常 - 全部，用于超管
export const fetchExceptionViewAll = (params) => ({ url: `/driver/getException/${params['id']}`, method: 'get', loading: true, delay: 500 });
